...
// Drawing machine: single with VARIABLE STROKE WEIGHT
// function draw() {
// if (mouseIsPressed){
// line(mouseX, mouseY, anchor[0], anchor[1])
// console.log(mouseIsPressed);
...
// Drawing machine: single with RANDOM COLOR
// function draw() {
// if (mouseIsPressed){
// line(mouseX, mouseY, anchor[0], anchor[1])
// console.log(mouseIsPressed);
...
// initial draw function blue-ish, from center point
// function draw() {
//   if (mouseIsPressed) {
...
// random spastic drawing single color
// 	 function draw() {
//   if (mouseIsPressed) {
...
//random spastic drawing multi color
//   function draw() {
//   if (mouseIsPressed) {
//   var x = random(50, 1800);
//   var y = random(1, 800);
...
// vertical random horizontal color bars chunky
// function draw() {
//   if (mouseIsPressed) {
