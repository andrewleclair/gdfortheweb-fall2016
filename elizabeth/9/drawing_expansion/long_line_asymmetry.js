...
// to make crazy circles drawing from a sort of clickable point
function draw() {
if (mouseIsPressed) {
ellipse(mouseX, mouseY, -mouseX+anchor[0], -mouseY+anchor[1]); // this needs debugging but could work
console.log(mouseIsPressed);
fill(random(225, 275), random(225, 275), random(50));
...
// console.log(mouseIsPressed);
// stroke(random(250), random(0), random(0));
// }
// }
