...
// this creates series of green horizontal lines, drawn vertical, from the x midpoint
function draw() {
  if (mouseIsPressed) {
  	line(mouseX, mouseY, 800, mouseY);
  	console.log(mouseIsPressed);
...
// this creates a midline and a tiltpoint with 4pt stroke X
...
// to make symmetrical drawing from a fixed centerpoint X
...
// to make symmetrical drawing from a sort of clickable centerpoint X
